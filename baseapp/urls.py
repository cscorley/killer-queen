...
urlpatterns = [
    ...
    url(r'^account/update/$', hello.views.UserUpdateView.as_view(), name='account_update'),
    url(r'^account/update/password/$', hello.views.user_password_change, name='account_update_password'),
